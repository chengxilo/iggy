...
Commands:
  create  Create topic with given name, number of partitions, compression algorithm and expiry time for given stream ID [alias: c]
  delete  Delete topic with given ID in given stream ID [alias: d]
